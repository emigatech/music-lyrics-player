var EmigaLyrics = function(e) {
    ...
    class i {
        constructor(e) {
            this.element = e.element, this.element.classList.contains("emiga--enabled") || (this.element.classList.add("emiga"), e.mediaElement ? this.mediaElement = e.mediaElement : this.mediaElement = this.findMediaElementBefore(this.element), e.viewMode ? this.viewMode = e.viewMode : this.viewMode = "default", this.element.classList.add("emiga--" + this.viewMode), "full" !== this.viewMode && e.height && (this.element.style.height = e.height + "px"), e.alignment && (this.element.style.textAlign = e.alignment), this.scrollerIntervalDuration = 200, this.scrollerIntervalStep = 10, this.lineElements = [], this.setStatus = this.setStatus.bind(this), this.synchronize = this.synchronize.bind(this), this.scroll = this.scroll.bind(this), this.parseLyrics(), this.enableLyrics())
        }
        ...
        parseLyrics() {
            ...
            for (let i = 0; i < e.length; i++) {
                ...
                r.className = "emiga__line", this.element.appendChild(r), this.lineElements.push(r);
                let s = e[i].trim(),
                    o = s.match(/\[(\d+:)?\d+:\d+\.\d+\]/g) || [],
                    a = s.match(/^\[(\d+:)?\d+:\d+\.\d+\]/g) || [],
                    l = s.match(/\[(\d+:)?\d+:\d+\.\d+\]$/g) || [];
                ...
                }, this), n = []), a.length > 0 ? (r.dataset.start = this.decodeTimeStamp(a[0]), t = this.decodeTimeStamp(a[0])) : r.dataset.start = t, l.length > 0 ? (r.dataset.end = this.decodeTimeStamp(l[0]), t = this.decodeTimeStamp(l[0])) : (r.dataset.end = 1 / 0, n.push(r)), (s = s.replace(/\[(\d+:)?\d+:\d+\.\d+\]/g, "")) || (s = "&nbsp;"), r.innerHTML = s
            }
            return this
        }
        enableLyrics() {
            return this.mediaElement ? (this.element.scrollTop = 0, this.mediaElement.addEventListener("timeupdate", this.synchronize), this.mediaElement.addEventListener("play", this.setStatus), this.mediaElement.addEventListener("playing", this.setStatus), this.mediaElement.addEventListener("pause", this.setStatus), this.mediaElement.addEventListener("waiting", this.setStatus), this.mediaElement.addEventListener("ended", this.setStatus), this.element.classList.add("emiga--enabled"), this) : (console.log("no media found"), this)
        }
        setStatus(e) {
            let t;
            switch (e.type) {
            ...
            this.element.classList.remove("emiga--playing", "emiga--paused", "emiga--waiting", "emiga--ended"), t && this.element.classList.add("emiga--" + t)
        }
        synchronize() {
            ...
            if (this.lineElements.forEach(i => {
                    e >= i.dataset.start && e <= i.dataset.end ? (i.classList.contains("emiga__line--active") || (t = !0, i.classList.add("emiga__line--active")), n.push(i)) : i.classList.contains("emiga__line--active") && (t = !0, i.classList.remove("emiga__line--active"))
                }), t && n.length > 0) {
    ...
    document.addEventListener("DOMContentLoaded", function() {
        let e = document.getElementsByClassName("emiga");
    ...
    function y(e, t) {
        ...
        if (t.singleton) {
            var o = c++;
            n = l || (l = b(t)), i = E.bind(null, n, o, !1), r = E.bind(null, n, o, !0)
